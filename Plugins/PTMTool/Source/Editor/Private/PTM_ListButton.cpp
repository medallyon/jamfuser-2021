...
void SPTM_ListButton::Construct(const FArguments &InArgs) {
	...
	//
	PickedStyle = &FEditorStyle::Get().GetWidgetStyle<FButtonStyle>("FlatButton.Info");
	ErrorStyle = &FEditorStyle::Get().GetWidgetStyle<FButtonStyle>("FlatButton.Danger");
	SafeStyle = &FEditorStyle::Get().GetWidgetStyle<FButtonStyle>("FlatButton.DarkGrey");
	ClashStyle = &FEditorStyle::Get().GetWidgetStyle<FButtonStyle>("FlatButton.Warning");
	TransferStyle = &FEditorStyle::Get().GetWidgetStyle<FButtonStyle>("FlatButton.Success");
	//
	//
...
FText SPTM_ListButton::GetButtonTooltip() const {
	...
	if (PPInfo.Property->IsA(FFloatProperty::StaticClass())) {return FText::FromString(TEXT("Float Property"));}
...
const FSlateBrush* SPTM_ListButton::GetTypeBrush() const {
	...
	//
	if (PPInfo.Property->IsA(FObjectProperty::StaticClass())) {Brush=FEditorStyle::GetBrush(TEXT("GraphEditor.SpawnActor_16x"));}
	if (PPInfo.Property->IsA(FSetProperty::StaticClass())) {Brush=FEditorStyle::GetBrush(TEXT("Kismet.VariableList.SetTypeIcon"));}
	if (PPInfo.Property->IsA(FMapProperty::StaticClass())) {Brush=FEditorStyle::GetBrush(TEXT("Kismet.VariableList.MapKeyTypeIcon"));}
	if (PPInfo.Property->IsA(FArrayProperty::StaticClass())) {Brush=FEditorStyle::GetBrush(TEXT("Kismet.VariableList.ArrayTypeIcon"));}
	//
	return Brush;
}
...
FSlateColor SPTM_ListButton::GetTypeColor() const {
	...
	if (PPInfo.Property->IsA(FFloatProperty::StaticClass())) {Color=FSlateColor(FLinearColor(0,0.8f,0)); return Color;}
	...
	if (PPInfo.Property->IsA(FSetProperty::StaticClass())) {
		...
		if (PSet->ElementProp && PSet->ElementProp->IsA(FFloatProperty::StaticClass())) {Color=FSlateColor(FLinearColor(0,0.8f,0)); return Color;}
	...
	if (PPInfo.Property->IsA(FMapProperty::StaticClass())) {
		...
		if (PMap->KeyProp && PMap->KeyProp->IsA(FFloatProperty::StaticClass())) {Color=FSlateColor(FLinearColor(0,0.8f,0)); return Color;}
	...
	if (PPInfo.Property->IsA(FArrayProperty::StaticClass())) {
		...
		if (PArray->Inner && PArray->Inner->IsA(FFloatProperty::StaticClass())) {Color=FSlateColor(FLinearColor(0,0.8f,0)); return Color;}
...
FSlateColor SPTM_ListButton::GetValueColor() const {
	...
	if (PPInfo.Property->IsA(FMapProperty::StaticClass())) {
		...
		if (PMap->ValueProp && PMap->ValueProp->IsA(FFloatProperty::StaticClass())) {Color=FSlateColor(FLinearColor(0,0.8f,0)); return Color;}
